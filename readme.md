...
- [/src/constants/index.js](https://github.com/amjadiftikhar/personal-portfolio/blob/master/src/constants/index.js) contains all the personal information one needs to change. Each website section is written as a JavaScript object and is pretty intuitive to change.
...
- Icons
  ...
  - Import the icon into [`/src/constants/index.js`](https://github.com/amjadiftikhar/personal-portfolio/blob/master/src/constants/index.js) (Eg: `import { ... SiReact, } from "react-icons/si";` here)

2. Website title and icon

- Go to [`index.html`](https://github.com/amjadiftikhar/personal-portfolio/blob/master/index.html) and change the [`title`](https://github.com/amjadiftikhar/personal-portfolio/blob/master/index.html#L7") to your name.
- Also, change the link to the title [icon](https://github.com/amjadiftikhar/personal-portfolio/blob/master/index.html#L5)

3. Assets

- Add any assets (images) to the [`assets`](https://github.com/amjadiftikhar/personal-portfolio/tree/master/src/assets) folder.
- Import the asset and export it using the[`/src/assets/index.js`](https://github.com/amjadiftikhar/personal-portfolio/blob/master/src/assets/index.js) file.
...
- Enter the new `personal-portfolio` directory with `cd personal-portfolio`
- Set the upstream remote to the original repository url so that git knows where to fetch updates from in future: `git remote add upstream https://github.com/amjadiftikhar/personal-portfolio.git`
...
- Follow the [installation guide](https://github.com/amjadiftikhar/personal-portfolio/blob/master/readme.md#installation-guide) to install the software
- Create a new feature branch with `git checkout -b <name-of-your-feature-branch>`
- Make changes and commit them in the feature branch.
- Once done developing, switch back to the main branch with `git checkout main` ; pull the latest version of the repo with `git pull https://github.com/amjadiftikhar/personal-portfolio.git master`
- Switch back to the feature branch with `git checkout <name-of-your-feature-branch>`. Apply the new changes on top of the latest version of the repo with `git rebase master`
...
- [Submit a Pull Request](https://docs.github.com/en/get-started/quickstart/contributing-to-projects#making-a-pull-request) to the master branch.
