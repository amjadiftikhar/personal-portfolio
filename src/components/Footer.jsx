  ...
  <footer id="contactMe" className="bg-gray-900 sm:px-16 px-6">
    ...
    >
      <div className={` ${layout.sectionInfo}`}>
        <h2 className="text-xl font-bold text-dimWhite font-poppins dark:text-white hover:text-gray-700 dark:hover:text-gray-300">
          {aboutMe.name}
        </h2>
        <p
      ...
      <div className="md:ml-auto mt-10 md:mt-0">
        <img
          src={profilePic}
          alt="Amjad Iftikhar"
          className="w-[200px] h-[200px] border-1 border-teal-200 relative z-[5] rounded-full"
        />
      </div>
    </div>
  </footer>
